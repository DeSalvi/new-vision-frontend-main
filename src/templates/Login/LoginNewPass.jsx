                ...
                {!successful && (
                    <>
                        ...
                        <div className="mb-2">
                            ...
                            <input type="password" id="senha" className="form-control text-center fw-medium shadow" minLength={8}
                                name="senha"
                        ...
                        <div>
                            ...
                            <input type="password" id="newpass" className="form-control text-center fw-medium shadow" minLength={8}
                                name="newpass"
